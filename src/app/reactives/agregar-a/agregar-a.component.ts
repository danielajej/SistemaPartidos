...
import { RegistrosArbitros } from '../interfaces/equipos';
...
export class AgregarAComponent implements OnInit {
  ...
  guardar2() {
    this.conexion.Post('futbolistas', 'InsertA', this.Formulario.value).subscribe((dato: any) => {
      console.log(dato);
      if (dato['estatus']) {
